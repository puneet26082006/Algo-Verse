...
// You are given q queries and for each query you are given n and r and you have to calculate the value of nCr % 1e9 + 7 .
// q <= 1e6 , n <= 1e9 , r <= 20 .
