...
// O(NlogM) with Binary Search?
// Given 2 sorted arrays of size N and M, for each element in 1st array find
// number of elements smaller than that in the 2nd array
// 7

// Input : a = [1 4 5 9 11], b = [2 3 6 7 10]
// Output : [2 3 6 7 10]
