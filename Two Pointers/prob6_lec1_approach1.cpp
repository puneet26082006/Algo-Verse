...
// Count the number of subarrays whose sum is greater then equal to k and a[i] > 0 .
// Input : a = [1 2 3 4 5], k = 1 
// Output : 4 


// Approach => no. of subarray with sum >= k = total_subarrays - subarray with sum <= k
