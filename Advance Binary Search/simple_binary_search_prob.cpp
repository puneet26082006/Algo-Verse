...
int binary_search_left(vector<int>& a, int l, int n){
    int si = 0 ;
    int ei = n - 1;
    int A = n;
    while(si <= ei){
...
int binary_search_right(vector<int>& a, int r, int n){
    int si = 0 ;
    int ei = n - 1;
    int B = -1 ;
...
void solve() {
    ...
    while(k--){
        ...
        int A = binary_search_left(a, l, n) ;
        int B = binary_search_right(a, r, n) ;
