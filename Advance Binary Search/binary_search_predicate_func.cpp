...
// Given an array of workloads, split it among ‘k’ workers, such that the maximum
// work that any worker has to do is minimised (can’t change order of workloads).
...
// Is it possible to partition workload in a way that the highest workload of any
// worker is less than 170?
